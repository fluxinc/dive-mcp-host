...
class SqliteDatabase(Database):
    ...
    async def get_chat_with_messages(
        self, chat_id: str, opts: Options | None = None
    ) -> ChatMessage | None:
        raise NotImplementedError

    async def create_chat(
        self, chat_id: str, title: str, opts: Options | None = None
    ) -> Chat | None:
        raise NotImplementedError

    async def create_message(
        self, message: NewMessage, opts: Options | None = None
    ) -> Message:
        raise NotImplementedError
    ...
    async def delete_messages_after(
        self, chat_id: str, message_id: str, opts: Options | None = None
    ) -> None:
        raise NotImplementedError

    async def update_message_content(
        self, message_id: str, data: QueryInput, opts: Options | None = None
    ) -> Message:
        raise NotImplementedError
